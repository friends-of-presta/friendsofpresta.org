...
Route::group(["prefix"=>"/admin"], function() {
    ...
    Route::get('/inscription/{inscription}/status/{status}', 'Admin\InscriptionController@updateStatus')->name('admin.inscription.status')->middleware('can:updateStatus,inscription,status');

    ...
    <div class="container-fluid p-1 px-2">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <select id="role" multiple class="form-control @error('role') is-invalid @enderror" name="role[]" required autocomplete="role" autofocus>
                        @foreach($roles as $id => $role)
                            <option value="{{ $id }}" @if(is_array(old('role')) and in_array($id, old('role'))) selected @endif>{{ $role }}</option>
                        @endforeach
                    </select>
